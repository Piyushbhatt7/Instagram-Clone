...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    var arrContent = [
      {
        "img":
            "https://ugc.production.linktr.ee/4e1691b1-483b-4a81-8a40-631768317055_inbound3426524437699628265.jpeg?io=true&size=avatar-v3_0",
        "name": "Your Strory"
      },
      {
        "img":
            "https://www.basketballnetwork.net/.image/c_fit%2Ccs_srgb%2Cfl_progressive%2Cq_auto:good%2Cw_1280/MTk5NjcyODc5MjY3MTk0NDk2/kobe-bryant-1.jpg",
        "name": "kobeBry"
      },
      {
        "img":
      ...
      {
        "img":
            "https://images.bauerhosting.com/legacy/media/5d96/4115/c11f/b277/1531/ec33/free-guy-crop.jpg?ar=16%3A9&fit=crop&crop=top&auto=format&w=1440&q=80",
        "name": "ryanRond"
      },
      {
        "img":
      ...
      {
        "img":
            "https://media.cnn.com/api/v1/images/stellar/prod/231209082454-02-cristiano-ronaldo-al-nassr-1208.jpg?c=original",
        "name": "cristiano"
      },
      {
        "img":
            "https://media.istockphoto.com/id/1227336313/photo/portrait-of-teenager-using-her-laptop-at-home.jpg?s=612x612&w=0&k=20&c=IGH1Qtk0SWLkGyHylUFfjQNxFav9gmcYEj5mJ6v3wfs=",
        "name": "Monalis",
      },
      {
        "img":
            "https://petapixel.com/assets/uploads/2022/01/VAI_01-22_People_Panther_JPG_white_hor_046-800x460.jpg",
        "name": "samaltma"
      }
    ];
    return Scaffold(
          ...
          children: [ 
            ...
            Row(
              children: [
                ...
                Text(
                  "Liked by craige_02 and 44,868 others",
              ...
              children: [
                ...
                Text(
                  ...
                  style: TextStyle(
                      ...
                      color: Color(0XFF9F9F9F9)),
                ),
                SizedBox(
                  width: 5,
                ),
                Text(
                  "The Tokyo city in Japan was amazing",
                  style: TextStyle(fontSize: 13, color: Color(0XFFF9F9F9)),
                )
              ],
            )
